-- -- PASSWORD = 'cascaded'
-- INSERT INTO LAWYER(ID, EMAIL, EMAIL_VERIFIED, FIRST_NAME, LAST_NAME, PASSWORD, ROLE, PHONE_NUMBER, CITY, PASSWORD_SET, LOGIN_ATTEMPTS, LAST_LOGIN_ATTEMPT, LOCKED_UNTIL, LOCK_REASON, TWO_FACTOR_KEY, DELETED)
